#include "lib_display/display_databus.h"
    ...
    #ifndef __RLCD_LIBDISPLAY_ESP32PAR8QQQ_H__
        #define __RLCD_LIBDISPLAY_ESP32PAR8QQQ_H__

class Arduino_ESP32PAR8QQQ : public Arduino_DataBus
{
public:
    Arduino_ESP32PAR8QQQ(int8_t dc, int8_t cs, int8_t wr, int8_t rd, int8_t d0, int8_t d1, int8_t d2, int8_t d3, int8_t d4, int8_t d5, int8_t d6, int8_t d7);  // Constructor
...
private:
    ...
    #endif // __RLCD_LIBDISPLAY_ESP32PAR8QQQ_H__
