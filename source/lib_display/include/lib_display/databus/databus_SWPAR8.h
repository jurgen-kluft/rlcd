#ifndef __RLCD_LIBDISPLAY_SWPAR8_H__
#define __RLCD_LIBDISPLAY_SWPAR8_H__
...
{
public:
    Arduino_SWPAR8(int8_t dc, int8_t cs, int8_t wr, int8_t rd, int8_t d0, int8_t d1, int8_t d2, int8_t d3, int8_t d4, int8_t d5, int8_t d6, int8_t d7);  // Constructor
...
#endif // __RLCD_LIBDISPLAY_SWPAR8_H__
