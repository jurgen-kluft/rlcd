...
static const uint8_t st77916_150_init_operations[] = {BEGIN_WRITE,
                                                      WRITE_C8_D8,
                                                      0xF0,
                                                      0x28,
                                                      WRITE_C8_D8,
...
static const uint8_t st77916_180_init_operations[] = {BEGIN_WRITE,
                                                      WRITE_C8_D8,
                                                      0xF0,
                                                      0x08,
                                                      WRITE_C8_D8,
...
{
public:
    Arduino_ST77916(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = ST77916_TFTWIDTH, int16_t h = ST77916_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
                    uint8_t row_offset2 = 0, const uint8_t *init_operations = st77916_180_init_operations, size_t init_operations_len = sizeof(st77916_180_init_operations));
