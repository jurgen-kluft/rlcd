...
static const uint8_t jbt6k71_init_operations[] = {BEGIN_WRITE, WRITE_COMMAND_16, 0x00, 0x00,  // exiting from deep standby mode
                                                  END_WRITE,

                                                  DELAY, 10,  // spec 1ms

                                                  BEGIN_WRITE, WRITE_COMMAND_16, 0x00, 0x00, END_WRITE,
                                                  ...
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x00, 0x1d,  // mode setting
                                                  0x00, 0x05,                              // exit standby
                                                  END_WRITE,

                                                  DELAY, 100,  // spec 1ms

                                                  BEGIN_WRITE, WRITE_C16_D16, 0x00, 0x00,  // oscillation setting
                                                  0x00, 0x01,                              // set to on
                                                  END_WRITE,
                                                  ...
                                                  // Display control
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x00, 0x02,  // LCD driver AC control
                                                  ...
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x00, 0x12,  // LTPS control setting 1
                                                  0x03, 0x03,
                                                  ...
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x01, 0x03,  // Power Supply Control (2)
                                                  0x00, 0x07,                              // Boosting clock mode: Dual mode, XVDD output voltage: 5.4V
                                                  END_WRITE,

                                                  DELAY, 100,

                                                  BEGIN_WRITE, WRITE_C16_D16, 0x01, 0x05,  // Power supply control (4)
                                                  ...
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x03, 0x00, 0x02, 0x00,                            // chan
                                                  WRITE_C16_D16, 0x03, 0x01, 0x00, 0x02,                                         //
                                                  WRITE_C16_D16, 0x03, 0x02, 0x00, 0x00, WRITE_C16_D16, 0x03, 0x03, 0x03, 0x00,  //
                                                  WRITE_C16_D16, 0x03, 0x04, 0x07, 0x00, WRITE_C16_D16, 0x03, 0x05, 0x00, 0x70,  //
                                                  ...
                                                  BEGIN_WRITE, WRITE_C16_D16, 0x01, 0x01, 0x00, 0x01,  // Auto sequence Control, AUTO
...
{
public:
    Arduino_JBT6K71(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = JBT6K71_TFTWIDTH, int16_t h = JBT6K71_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
