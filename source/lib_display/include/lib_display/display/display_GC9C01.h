...
static const uint8_t gc9c01_init_operations[] = {BEGIN_WRITE, WRITE_COMMAND_8, 0xfe,                // internal reg enable
                                                 ...
                                                 WRITE_C8_D8, 0x36, 0x00, WRITE_C8_D8, 0x3a, 0x05,  // 565 frame
                                                 WRITE_C8_D8, 0xEC, 0x77,

                                                 WRITE_C8_BYTES, 0x74, 6,  // rtn 60Hz
                                                 0x01, 0x80, 0x00, 0x00, 0x00, 0x00,

                                                 WRITE_C8_D8, 0x98, 0x3E, WRITE_C8_D8, 0x99, 0x3E, WRITE_C8_D8, 0xC3, 0x2A, WRITE_C8_D8, 0xC4, 0x18, WRITE_C8_D16, 0xA1, 0x01, 0x04,  // SRAM RD OPTION
                                                 ...
                                                 WRITE_C8_D8, 0x7D, 0x72, WRITE_C8_D8, 0x7E, 0x38,  // VGL_BT=1 5X  (BT=0:6X)  RT=0

                                                 WRITE_C8_BYTES, 0x70, 10, 0x02, 0x03, 0x09, 0x05,  // vgh_clk
                                                 0x0C, 0x06, 0x09, 0x05,                            // vgh_clk_porch  0E
                                                 0x0C, 0x06,                                        // vcl_clk_porch  0E

                                                 WRITE_C8_BYTES, 0x90, 4, 0x06, 0x06, 0x05, 0x06,  // bvdd_clk1_ad1

                                                 WRITE_C8_BYTES, 0x93, 3, 0x45, 0xFF, 0x00,

                                                 // gamma start
                                                 WRITE_C8_BYTES, 0xF0, 6, 0x45, 0x09, 0x08, 0x08, 0x26, 0x2A,

                                                 WRITE_C8_BYTES, 0xF1, 6, 0x43, 0x70, 0x72, 0x36, 0x37, 0x6F,

                                                 WRITE_C8_BYTES, 0xF2, 6, 0x45, 0x09, 0x08, 0x08, 0x26, 0x2A,

                                                 WRITE_C8_BYTES, 0xF3, 6, 0x43, 0x70, 0x72, 0x36, 0x37, 0x6F,

                                                 WRITE_COMMAND_8, GC9C01_SLPOUT, END_WRITE,

                                                 DELAY, GC9C01_SLPOUT_DELAY,

                                                 BEGIN_WRITE, WRITE_COMMAND_8, GC9C01_DISPON,  // Display on
                                                 END_WRITE,
...
{
public:
    Arduino_GC9C01(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = GC9C01_TFTWIDTH, int16_t h = GC9C01_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
