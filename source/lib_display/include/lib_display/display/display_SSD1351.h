 ...
 */
#ifndef __RLCD_LIBDISPLAY_SSD1351_H__
#define __RLCD_LIBDISPLAY_SSD1351_H__
...
{
public:
    Arduino_SSD1351(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, int16_t w = SSD1351_TFTWIDTH, int16_t h = SSD1351_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0, uint8_t row_offset2 = 0);
