...
{
public:
    Arduino_SSD1357(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, int16_t w = SSD1357_TFTWIDTH, int16_t h = SSD1357_TFTHEIGHT, int16_t col_offset1 = GFX_NOT_DEFINED, int16_t row_offset1 = GFX_NOT_DEFINED,
