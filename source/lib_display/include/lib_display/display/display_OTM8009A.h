#ifndef __RLCD_LIBDISPLAY_OTM8009A_H__
#define __RLCD_LIBDISPLAY_OTM8009A_H__
...
{
public:
    Arduino_OTM8009A(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = OTM8009A_TFTWIDTH, int16_t h = OTM8009A_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
