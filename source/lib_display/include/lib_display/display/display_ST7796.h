 ...
 */
#ifndef __RLCD_LIBDISPLAY_ST7796_H__
#define __RLCD_LIBDISPLAY_ST7796_H__
...
static const uint8_t st7796_init_operations[] = {
    ...
    // Exit Extension Command Control
    ...
    // Display On Sequence
    BEGIN_WRITE,
    WRITE_COMMAND_8, 0x38,             // Idle Mode Off
...
{
public:
    Arduino_ST7796(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = ST7796_TFTWIDTH, int16_t h = ST7796_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
