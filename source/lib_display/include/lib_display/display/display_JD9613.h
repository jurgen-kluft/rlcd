...
static const uint8_t jd9613_init_operations[] = {BEGIN_WRITE,
                                                 WRITE_C8_D8,
                                                 0xfe,
                                                 0x01,
...
{
public:
    Arduino_JD9613(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, int16_t w = JD9613_TFTWIDTH, int16_t h = JD9613_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0, uint8_t row_offset2 = 0);
