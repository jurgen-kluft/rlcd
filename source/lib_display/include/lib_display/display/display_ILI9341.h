...
static const uint8_t ili9341_type1_init_operations[] = {BEGIN_WRITE,
                                                        WRITE_C8_BYTES,
                                                        0xCF,
                                                        3,
                                                        0x00,
                                                        ...
                                                        WRITE_C8_D8,
                                                        ILI9341_PWCTR1,
                                                        0x10,  // Power control VRH[5:0]
                                                        WRITE_C8_D8,
                                                        ILI9341_PWCTR2,
                                                        0x00,  // Power control SAP[2:0];BT[3:0]
                                                        WRITE_C8_D16,
                                                        ILI9341_VMCTR1,
                                                        0x30,
                                                        0x30,  // VCM control
                                                        ...
                                                        WRITE_COMMAND_8,
                                                        ILI9341_SLPOUT,  // Exit Sleep
                                                        WRITE_COMMAND_8,
                                                        ILI9341_DISPON,  // Display on
                                                        END_WRITE};

static const uint8_t ili9341_type2_init_operations[] = {BEGIN_WRITE,
                                                        WRITE_C8_BYTES,
                                                        0xEF,
                                                        3,
                                                        0x03,
...
static const uint8_t ili9341_type3_init_operations[] = {BEGIN_WRITE,
                                                        WRITE_C8_BYTES,
                                                        0xCF,
                                                        3,
                                                        0x00,
...
{
public:
    Arduino_ILI9341(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = ILI9341_TFTWIDTH, int16_t h = ILI9341_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
                    uint8_t row_offset2 = 0, const uint8_t *init_operations = ili9341_type1_init_operations, size_t init_operations_len = sizeof(ili9341_type1_init_operations));
