...
static const uint8_t nv3041a_init_operations[] = {BEGIN_WRITE, WRITE_C8_D8, 0xff, 0xa5,
                                                  ...
                                                  0x00, WRITE_C8_D8, 0xA0,  // gam_VRN0		 0-
                                                  0x00,

                                                  WRITE_C8_D8, 0x81,        // gam_vrp1	1				   6bit
                                                  0x07, WRITE_C8_D8, 0xA1,  // gam_VRN1		 1-
                                                  0x06,

                                                  WRITE_C8_D8, 0x82,        // gam_vrp2	 2					6bit
                                                  0x02, WRITE_C8_D8, 0xA2,  // gam_VRN2		 2-
                                                  0x01,
                                                  ...
                                                  0x37, WRITE_C8_D8, 0xA3,  // gam_VRN3		61-
                                                  0x37,

                                                  WRITE_C8_D8, 0x84,        // gam_vrp4	  62			 6bit
                                                  0x35, WRITE_C8_D8, 0xA4,  // gam_VRN4		62-
                                                  0x35,

                                                  WRITE_C8_D8, 0x85,        // gam_vrp5	  63			 6bit
                                                  0x3f, WRITE_C8_D8, 0xA5,  // gam_VRN5		63-
                                                  0x3f,
                                                  //
                                                  ...
                                                  0x0a, WRITE_C8_D8, 0xAb,  // gam_PKN3		10-
                                                  0x0a,

                                                  WRITE_C8_D8, 0x8c,        // gam_PKP4	   16				 5bit
                                                  0x14, WRITE_C8_D8, 0xAc,  // gam_PKN4		16-
                                                  0x08,

                                                  WRITE_C8_D8, 0x8d,        // gam_PKP5		22				 5bit
                                                  0x17, WRITE_C8_D8, 0xAd,  // gam_PKN5		22-
                                                  0x07,
                                                  ...
                                                  0x1B, WRITE_C8_D8, 0xAf,  // gam_PKN7		34-
                                                  0x07,

                                                  WRITE_C8_D8, 0x90,        // gam_PKP8		 46				   5bit
                                                  0x04, WRITE_C8_D8, 0xB0,  // gam_PKN8		46-
                                                  0x04,

                                                  WRITE_C8_D8, 0x91,        // gam_PKP9		 52					5bit
                                                  0x0A, WRITE_C8_D8, 0xB1,  // gam_PKN9		52-
                                                  0x0A,

                                                  WRITE_C8_D8, 0x92,        // gam_PKP10		58					5bit
                                                  0x16, WRITE_C8_D8, 0xB2,  // gam_PKN10		58-
                                                  0x15,

                                                  WRITE_C8_D8, 0xff, 0x00,

                                                  WRITE_C8_D8, 0x11, 0x00, END_WRITE,

                                                  DELAY, 120,

                                                  BEGIN_WRITE, WRITE_C8_D8, 0x29, 0x00, END_WRITE,
...
{
public:
    Arduino_NV3041A(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = NV3041A_TFTWIDTH, int16_t h = NV3041A_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
