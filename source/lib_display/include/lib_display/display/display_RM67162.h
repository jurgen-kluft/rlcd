...
static const uint8_t rm67162_init_operations[] = {BEGIN_WRITE,     WRITE_COMMAND_8,      RM67162_SLPOUT,  // Sleep Out
                                                  END_WRITE,

                                                  DELAY,           RM67162_SLPOUT_DELAY,

                                                  BEGIN_WRITE,     WRITE_C8_D8,          RM67162_PIXFMT, 0x55,  // Interface Pixel Format 16bit/pixel
...
static const uint8_t rm67162_spi_init_operations[] = {BEGIN_WRITE,    WRITE_C8_D8,
                                                      0xFE,           0x04,  // SET PAGE3
                                                      WRITE_C8_D8,    0x6A,
                                                      0x00,           WRITE_C8_D8,
                                                      0xFE,           0x05,  // SET PAGE4
                                                      ...
                                                      WRITE_C8_D8,    RM67162_BRIGHTNESS,
                                                      0xBF,           WRITE_C8_D8,
                                                      0x53,           0x20,
                                                      WRITE_C8_D8,    0x35,
                                                      0x00,           WRITE_C8_D8,
                                                      RM67162_PIXFMT, 0x75,  // Interface Pixel Format 16bit/pixel (SPI)
                                                      WRITE_C8_D8,    0xC4,
                                                      0x80,           WRITE_COMMAND_8,
                                                      RM67162_SLPOUT,  // Sleep Out
                                                      END_WRITE,

                                                      DELAY,          RM67162_SLPOUT_DELAY,

                                                      BEGIN_WRITE,    WRITE_COMMAND_8,
                                                      RM67162_DISPON,  // Display on
                                                      END_WRITE,
