...
static const uint8_t GC9D01_init_operations[] = {BEGIN_WRITE,
                                                 WRITE_COMMAND_8,
                                                 0xFE,  // internal reg enable
                                                 WRITE_COMMAND_8,
                                                 0xEF,  // internal reg enable
                                                 WRITE_C8_D8,
                                                 0x80,
                                                 0xFF,
                                                 WRITE_C8_D8,
                                                 ...
                                                 WRITE_C8_D8,
                                                 0xC3,
                                                 0x19,  // Voltage Level Power control 2
                                                 WRITE_C8_D8,
                                                 0xC4,
                                                 0x19,  // Voltage Level Power control 3
                                                 WRITE_C8_D8,
                                                 0xC9,
                                                 0x3C,  // Voltage Level Power control 4
                                                 ...
                                                 WRITE_C8_D8,
                                                 0x36,
                                                 0x00,  // Memory Access Control

                                                 WRITE_COMMAND_8,
                                                 GC9D01_SLPOUT,  // Sleep OUT
                                                 END_WRITE,

                                                 DELAY,
                                                 GC9D01_SLPOUT_DELAY,  // 200 ms

                                                 BEGIN_WRITE,
                                                 WRITE_COMMAND_8,
                                                 GC9D01_DISPON,  // Display on
                                                 WRITE_COMMAND_8,
                                                 0x2C,  // Memory Write
                                                 END_WRITE,
...
{
public:
    Arduino_GC9D01(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = GC9D01_TFTWIDTH, int16_t h = GC9D01_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
