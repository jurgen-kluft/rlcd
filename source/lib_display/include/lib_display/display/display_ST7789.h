...
static const uint8_t st7789_type1_init_operations[] = {BEGIN_WRITE,
                                                       WRITE_COMMAND_8,
...
static const uint8_t st7789_type2_init_operations[] = {BEGIN_WRITE,
                                                       WRITE_C8_D8,
                                                       ST7789_COLMOD,
                                                       0x55,  // 3: Set color mode, 16-bit color
...
static const uint8_t st7789_type3_init_operations[] = {BEGIN_WRITE,     WRITE_C8_D8,         ST7789_COLMOD, 0x55,  // 3: Set color mode, 16-bit color
                                                       WRITE_COMMAND_8, ST7789_SLPOUT,       END_WRITE,

                                                       DELAY,           ST7789_SLPOUT_DELAY,

                                                       BEGIN_WRITE,     WRITE_COMMAND_8,     ST7789_DISPON, END_WRITE};
class Arduino_ST7789 : public Arduino_TFT
{
public:
    Arduino_ST7789(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = ST7789_TFTWIDTH, int16_t h = ST7789_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
                   uint8_t row_offset2 = 0, const uint8_t *init_operations = st7789_type1_init_operations, size_t init_operations_len = sizeof(st7789_type1_init_operations));
