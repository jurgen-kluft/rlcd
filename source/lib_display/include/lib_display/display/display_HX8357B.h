 ...
 */
#ifndef __RLCD_LIBDISPLAY_HX8357B_H__
#define __RLCD_LIBDISPLAY_HX8357B_H__
...
static const uint8_t hx8357b_init_operations[] = {BEGIN_WRITE,
                                                  WRITE_COMMAND_8,
                                                  HX8357B_EXIT_SLEEP_MODE,
                                                  END_WRITE,

                                                  DELAY,
                                                  HX8357B_SLPOUT_DELAY,

                                                  BEGIN_WRITE,
                                                  WRITE_COMMAND_8,
                                                  HX8357B_SET_EP_FUNCTION,
                                                  WRITE_BYTES,
                                                  4,
                                                  0x02,
                                                  0x01,
                                                  ...
                                                  WRITE_C8_D8,
                                                  HX8357B_SET_DISPLAY_TIMING_NORMAL,
                                                  0x10,  // ne inversion
                                                  ...
                                                  0x16,  // VCOMH
                                                  WRITE_C8_D16,
                                                  HX8357B_SET_POWER_NORMAL,
                                                  0x04,
                                                  0x22,  // 12
                                                  WRITE_C8_D16,
                                                  HX8357B_SET_POWER_PARTIAL,
                                                  0x04,
                                                  0x12,
                                                  WRITE_C8_D16,
                                                  HX8357B_SET_POWER_IDLE,
                                                  0x07,
                                                  0x12,
                                                  WRITE_C8_D8,
                                                  HX8357B_SET_PANEL_RELATED,
                                                  0x00,

                                                  WRITE_C8_D8,
                                                  HX8357B_SET_DISPLAY_FRAME,
                                                  0x08,  // 61.51Hz

                                                  WRITE_C8_D8,
                                                  HX8357B_SET_PIXEL_FORMAT,
                                                  0X55,
                                                  END_WRITE,
                                                  ...
                                                  BEGIN_WRITE,
                                                  WRITE_COMMAND_8,
                                                  HX8357B_SET_DISPLAY_ON,  // Display On
                                                  END_WRITE,
