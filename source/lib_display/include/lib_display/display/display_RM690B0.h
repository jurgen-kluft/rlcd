...
static const uint8_t rm690b0_init_operations[] = {BEGIN_WRITE,
                                                  WRITE_C8_D8,
                                                  0xFE,
                                                  0x20,  // SET PAGE
                                                  WRITE_C8_D8,
                                                  ...
                                                  WRITE_C8_D8,
                                                  0x5A,
                                                  0x51,  //! 230918:SWIRE FOR BV6804
                                                  WRITE_C8_D8,
                                                  0x5B,
                                                  0x2E,  //! 230918:SWIRE FOR BV6804
                                                  WRITE_C8_D8,
                                                  0xFE,
                                                  0x00,  // SET PAGE
                                                  WRITE_C8_D8,
                                                  RM690B0_PIXFMT,
                                                  0x55,  // Interface Pixel Format    16bit/pixel
                                                  WRITE_COMMAND_8,
                                                  0xC2,  // delay_ms(10);
                                                  END_WRITE,
                                                  DELAY,
                                                  ...
                                                  WRITE_C8_D8,
                                                  RM690B0_BRIGHTNESS,
                                                  0x00,  // Write Display Brightness  MAX_VAL=0XFF
                                                  WRITE_COMMAND_8,
                                                  RM690B0_SLPOUT,  // Sleep Out
                                                  END_WRITE,
                                                  DELAY,
                                                  RM690B0_SLPOUT_DELAY,
                                                  BEGIN_WRITE,
                                                  WRITE_COMMAND_8,
                                                  RM690B0_DISPON,  // Display on delay_ms(10);
                                                  END_WRITE,
                                                  DELAY,
                                                  10,
                                                  BEGIN_WRITE,
                                                  WRITE_C8_D8,
                                                  RM690B0_BRIGHTNESS,
                                                  0xD0,  // Write Display Brightness  MAX_VAL=0XFF
                                                  END_WRITE};

class Arduino_RM690B0 : public Arduino_OLED
{
public:
    Arduino_RM690B0(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, int16_t w = RM690B0_TFTWIDTH, int16_t h = RM690B0_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0, uint8_t row_offset2 = 0);
