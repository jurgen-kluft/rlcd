...
static const uint8_t co5300_init_operations[] = {BEGIN_WRITE, WRITE_COMMAND_8, CO5300_C_SLPOUT,  // Sleep Out
                                                 END_WRITE,
                                                 ...
                                                 WRITE_C8_D8, 0xFE, 0x00, WRITE_C8_D8, CO5300_W_SPIMODECTL, 0x80,
                                                 ...
                                                 WRITE_C8_D8, CO5300_W_WCTRLD1, 0x20, WRITE_C8_D8, CO5300_W_WDBRIGHTNESSVALHBM, 0xFF, WRITE_COMMAND_8, CO5300_C_DISPON,  // Display ON
...
{
public:
    Arduino_CO5300(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, int16_t w = CO5300_TFTWIDTH, int16_t h = CO5300_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0, uint8_t row_offset2 = 0);
