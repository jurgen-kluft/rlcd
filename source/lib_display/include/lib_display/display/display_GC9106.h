#ifndef __RLCD_LIBDISPLAY_GC9106_H__
#define __RLCD_LIBDISPLAY_GC9106_H__
...
static const uint8_t GC9106_init_operations[] = {BEGIN_WRITE,
...
{
public:
    Arduino_GC9106(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = GC9106_TFTWIDTH, int16_t h = GC9106_TFTHEIGHT, uint8_t col_offset1 = 24, uint8_t row_offset1 = 0, uint8_t col_offset2 = 24,
