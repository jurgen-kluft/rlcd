#ifndef __RLCD_LIBDISPLAY_GC9107_H__
#define __RLCD_LIBDISPLAY_GC9107_H__
...
static const uint8_t GC9107_init_operations[] = {BEGIN_WRITE,
                                                 WRITE_COMMAND_8,
                                                 0xEF,
                                                 WRITE_C8_D8,
                                                 0xEB,
...
{
public:
    Arduino_GC9107(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = GC9107_TFTWIDTH, int16_t h = GC9107_TFTHEIGHT, uint8_t col_offset1 = 2, uint8_t row_offset1 = 1, uint8_t col_offset2 = 2,
                   uint8_t row_offset2 = 1);
