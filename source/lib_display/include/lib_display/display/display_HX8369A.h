#ifndef __RLCD_LIBDISPLAY_HX8369A_H__
#define __RLCD_LIBDISPLAY_HX8369A_H__
...
static const uint8_t hx8369a_init_operations_part1[] = {BEGIN_WRITE,
                                                        WRITE_COMMAND_8,
                                                        HX8369A_SETEXTC,
                                                        WRITE_BYTES,
                                                        3,
...
static const uint8_t hx8369a_init_operations_part2[] = {WRITE_C8_D8,
                                                        HX8369A_SET_TEAR_ON,
                                                        0x00,

                                                        WRITE_C8_D8,
                                                        HX8369A_SET_PIXEL_FORMAT,
                                                        0x55,

                                                        WRITE_COMMAND_8,
                                                        HX8369A_EXIT_SLEEP_MODE,
                                                        END_WRITE,
                                                        ...
                                                        BEGIN_WRITE,
                                                        WRITE_COMMAND_8,
                                                        HX8369A_SET_DISPLAY_ON,  // Display On
                                                        END_WRITE};

class Arduino_HX8369A : public Arduino_TFT
{
public:
    Arduino_HX8369A(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED, uint8_t r = 0, bool ips = false, int16_t w = HX8369A_TFTWIDTH, int16_t h = HX8369A_TFTHEIGHT, uint8_t col_offset1 = 0, uint8_t row_offset1 = 0, uint8_t col_offset2 = 0,
