...
void Arduino_ESP32S2PAR8Q::endWrite() { CS_HIGH(); }
...
void Arduino_ESP32S2PAR8Q::write(uint8_t d) { WRITE(d); }
...
GFX_INLINE void Arduino_ESP32S2PAR8Q::DC_HIGH(void) { *_dcPortSet = _dcPinMask; }

GFX_INLINE void Arduino_ESP32S2PAR8Q::DC_LOW(void) { *_dcPortClr = _dcPinMask; }
