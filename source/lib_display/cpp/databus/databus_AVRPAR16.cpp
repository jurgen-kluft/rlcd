...
void Arduino_AVRPAR16::endWrite() { CS_HIGH(); }
...
void Arduino_AVRPAR16::write(uint8_t d) { WRITE16(d); }

void Arduino_AVRPAR16::write16(uint16_t d) { WRITE16(d); }
...
GFX_INLINE void Arduino_AVRPAR16::DC_HIGH(void) { *_dcPort |= _dcPinMaskSet; }

GFX_INLINE void Arduino_AVRPAR16::DC_LOW(void) { *_dcPort &= _dcPinMaskClr; }
