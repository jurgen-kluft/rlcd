...
void Arduino_RPiPicoPAR8::endWrite() { CS_HIGH(); }
...
void Arduino_RPiPicoPAR8::write(uint8_t d) { WRITE(d); }
...
GFX_INLINE void Arduino_RPiPicoPAR8::DC_HIGH(void) { sio_hw->gpio_set = _dcPinMask; }

GFX_INLINE void Arduino_RPiPicoPAR8::DC_LOW(void) { sio_hw->gpio_clr = _dcPinMask; }
