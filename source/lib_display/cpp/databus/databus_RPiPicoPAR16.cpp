...
void Arduino_RPiPicoPAR16::endWrite() { CS_HIGH(); }
...
void Arduino_RPiPicoPAR16::write(uint8_t d) { WRITE(d); }

void Arduino_RPiPicoPAR16::write16(uint16_t d) { WRITE16(d); }
...
GFX_INLINE void Arduino_RPiPicoPAR16::DC_HIGH(void) { sio_hw->gpio_set = _dcPinMask; }

GFX_INLINE void Arduino_RPiPicoPAR16::DC_LOW(void) { sio_hw->gpio_clr = _dcPinMask; }
