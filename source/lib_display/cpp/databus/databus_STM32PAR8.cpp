...
void Arduino_STM32PAR8::endWrite() { CS_HIGH(); }
...
void Arduino_STM32PAR8::write(uint8_t d) { WRITE(d); }
...
GFX_INLINE void Arduino_STM32PAR8::DC_HIGH(void) { _dcPORT->BSRR = _dcPinMaskSet; }

GFX_INLINE void Arduino_STM32PAR8::DC_LOW(void) { _dcPORT->BSRR = _dcPinMaskSet << 16; }
