...
Arduino_ESP32PAR16::Arduino_ESP32PAR16(int8_t dc, int8_t cs, int8_t wr, int8_t rd, int8_t d0, int8_t d1, int8_t d2, int8_t d3, int8_t d4, int8_t d5, int8_t d6, int8_t d7, int8_t d8, int8_t d9, int8_t d10, int8_t d11, int8_t d12, int8_t d13, int8_t d14,
                                       int8_t d15)
    : _dc(dc)
    , _cs(cs)
    , _wr(wr)
...
void Arduino_ESP32PAR16::endWrite() { CS_HIGH(); }
...
void Arduino_ESP32PAR16::write(uint8_t d) { WRITE(d); }

void Arduino_ESP32PAR16::write16(uint16_t d) { WRITE16(d); }
...
GFX_INLINE void Arduino_ESP32PAR16::DC_HIGH(void) { *_dcPortSet = _dcPinMask; }

GFX_INLINE void Arduino_ESP32PAR16::DC_LOW(void) { *_dcPortClr = _dcPinMask; }
