...
void Arduino_ESP32S2PAR8::endWrite() { CS_HIGH(); }
...
void Arduino_ESP32S2PAR8::write(uint8_t d) { WRITE(d); }
...
GFX_INLINE void Arduino_ESP32S2PAR8::DC_HIGH(void) { *_dcPortSet = _dcPinMask; }

GFX_INLINE void Arduino_ESP32S2PAR8::DC_LOW(void) { *_dcPortClr = _dcPinMask; }
