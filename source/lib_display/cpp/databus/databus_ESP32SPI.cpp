 ...
 *
 */
Arduino_ESP32SPI::Arduino_ESP32SPI(int8_t dc /* = GFX_NOT_DEFINED */, int8_t cs /* = GFX_NOT_DEFINED */, int8_t sck /* = GFX_NOT_DEFINED */, int8_t mosi /* = GFX_NOT_DEFINED */, int8_t miso /* = GFX_NOT_DEFINED */,
                                   uint8_t _spi_num /* = VSPI for ESP32, HSPI for S2 & S3, FSPI for C3 */, bool is_shared_interface /* = true */)
    : _dc(dc)
    , _spi_num(_spi_num)
 ...
 * @return GFX_INLINE
 */
GFX_INLINE void Arduino_ESP32SPI::DC_HIGH(void) { *_dcPortSet = _dcPinMask; }
 ...
 * @return GFX_INLINE
 */
GFX_INLINE void Arduino_ESP32SPI::DC_LOW(void) { *_dcPortClr = _dcPinMask; }
