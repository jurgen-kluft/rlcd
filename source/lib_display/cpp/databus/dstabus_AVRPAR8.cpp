    ...
    #include "lib_display/databus_AVRPAR8.h"
...
void Arduino_AVRPAR8::endWrite() { CS_HIGH(); }
...
void Arduino_AVRPAR8::write(uint8_t d) { WRITE(d); }
...
GFX_INLINE void Arduino_AVRPAR8::DC_HIGH(void) { *_dcPort |= _dcPinMaskSet; }

GFX_INLINE void Arduino_AVRPAR8::DC_LOW(void) { *_dcPort &= _dcPinMaskClr; }
