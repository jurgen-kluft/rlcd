...
void Arduino_ESP32S2PAR16Q::endWrite() { CS_HIGH(); }
...
void Arduino_ESP32S2PAR16Q::write(uint8_t d) { WRITE(d); }

void Arduino_ESP32S2PAR16Q::write16(uint16_t d) { WRITE16(d); }
...
GFX_INLINE void Arduino_ESP32S2PAR16Q::DC_HIGH(void) { *_dcPortSet = _dcPinMask; }

GFX_INLINE void Arduino_ESP32S2PAR16Q::DC_LOW(void) { *_dcPortClr = _dcPinMask; }
