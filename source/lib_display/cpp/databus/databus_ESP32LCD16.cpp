...
Arduino_ESP32LCD16::Arduino_ESP32LCD16(int8_t dc, int8_t cs, int8_t wr, int8_t rd, int8_t d0, int8_t d1, int8_t d2, int8_t d3, int8_t d4, int8_t d5, int8_t d6, int8_t d7, int8_t d8, int8_t d9, int8_t d10, int8_t d11, int8_t d12, int8_t d13, int8_t d14,
                                       int8_t d15)
    : _dc(dc)
    , _cs(cs)
    , _wr(wr)
...
bool Arduino_ESP32LCD16::begin(int32_t speed, int8_t dataMode)
{
    ...
    esp_lcd_i80_bus_config_t bus_config = {.dc_gpio_num        = _dc,
                                           .wr_gpio_num        = _wr,
                                           .clk_src            = LCD_CLK_SRC_PLL160M,
                                           .data_gpio_nums     = {_d0, _d1, _d2, _d3, _d4, _d5, _d6, _d7, _d8, _d9, _d10, _d11, _d12, _d13, _d14, _d15},
                                           .bus_width          = 16,
...
void Arduino_ESP32LCD16::writeCommand(uint8_t c) { WRITECOMMAND16(c); }

void Arduino_ESP32LCD16::writeCommand16(uint16_t c) { WRITECOMMAND16(c); }
...
void Arduino_ESP32LCD16::write(uint8_t d) { WRITE16(d); }

void Arduino_ESP32LCD16::write16(uint16_t d) { WRITE16(d); }
