...
Arduino_GC9106::Arduino_GC9106(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_GC9106::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = GC9106_MADCTL_MY | GC9106_MADCTL_MV | GC9106_MADCTL_BGR; break;
        case 2: r = GC9106_MADCTL_MY | GC9106_MADCTL_MX | GC9106_MADCTL_BGR; break;
        case 1: r = GC9106_MADCTL_MX | GC9106_MADCTL_MV | GC9106_MADCTL_BGR; break;
        default:  // case 0:
            r = GC9106_MADCTL_BGR;
            break;
    }
...
void Arduino_GC9106::invertDisplay(bool i) { _bus->sendCommand(_ips ? (i ? GC9106_INVOFF : GC9106_INVON) : (i ? GC9106_INVON : GC9106_INVOFF)); }
