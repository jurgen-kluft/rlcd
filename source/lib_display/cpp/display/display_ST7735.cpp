...
Arduino_ST7735::Arduino_ST7735(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2, bool bgr)
...
void Arduino_ST7735::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = ST7735_MADCTL_MY | ST7735_MADCTL_MV | (_bgr ? ST7735_MADCTL_BGR : ST7735_MADCTL_RGB); break;
        case 2: r = (_bgr ? ST7735_MADCTL_BGR : ST7735_MADCTL_RGB); break;
        case 3: r = ST7735_MADCTL_MX | ST7735_MADCTL_MV | (_bgr ? ST7735_MADCTL_BGR : ST7735_MADCTL_RGB); break;
        default:  // case 0:
...
void Arduino_ST7735::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ST7735_INVON : ST7735_INVOFF); }
