...
Arduino_SSD1331::Arduino_SSD1331(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, false, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_SSD1331::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_SSD1331::invertDisplay(bool i) { _bus->sendCommand(i ? SSD1331_INVERTDISPLAY : SSD1331_NORMALDISPLAY); }

void Arduino_SSD1331::displayOn(void) { _bus->sendCommand(SSD1331_DISPLAYALLON); }

void Arduino_SSD1331::displayOff(void) { _bus->sendCommand(SSD1331_DISPLAYALLOFF); }
