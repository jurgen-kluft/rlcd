...
void Arduino_ILI9806::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = (ILI9806_MADCTL_MY | ILI9806_MADCTL_MV | ILI9806_MADCTL_RGB); break;
        case 2: r = (ILI9806_MADCTL_MX | ILI9806_MADCTL_MY | ILI9806_MADCTL_RGB); break;
        case 1: r = (ILI9806_MADCTL_MX | ILI9806_MADCTL_MV | ILI9806_MADCTL_RGB); break;
        default:  // case 0:
...
void Arduino_ILI9806::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9806_INVON : ILI9806_INVOFF); }
