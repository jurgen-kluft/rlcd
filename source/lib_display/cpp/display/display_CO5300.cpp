...
bool Arduino_CO5300::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_CO5300::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = CO5300_MADCTL_COLOR_ORDER | CO5300_MADCTL_X_AXIS_FLIP; break;
        case 2:
            r = CO5300_MADCTL_COLOR_ORDER | CO5300_MADCTL_X_AXIS_FLIP | CO5300_MADCTL_Y_AXIS_FLIP;  // flip horizontal and flip vertical
            break;
        case 3: r = CO5300_MADCTL_COLOR_ORDER | CO5300_MADCTL_Y_AXIS_FLIP; break;
        default:  // case 0:
...
void Arduino_CO5300::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? CO5300_C_INVON : CO5300_C_INVOFF); }
