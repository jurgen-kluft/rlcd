...
Arduino_SSD1357::Arduino_SSD1357(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, int16_t col_offset1, int16_t row_offset1, int16_t col_offset2, int16_t row_offset2)
    : Arduino_TFT(bus, rst, r, false, w, h, (col_offset1 == GFX_NOT_DEFINED) ? ((SSD1357_TFTWIDTH - w) / 2) : col_offset1, (row_offset1 == GFX_NOT_DEFINED) ? 0 : row_offset1, (col_offset2 == GFX_NOT_DEFINED) ? ((SSD1357_TFTWIDTH - w) / 2) : col_offset2,
...
void Arduino_SSD1357::tftInit()
{
    ...
    static const uint8_t gamma_lut[63] = {0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x15, 0x17, 0x19, 0x1B, 0x1D, 0x1F, 0x21, 0x23, 0x25, 0x27, 0x2A, 0x2D, 0x30, 0x33,
                                          0x36, 0x39, 0x3C, 0x3F, 0x42, 0x45, 0x48, 0x4C, 0x50, 0x54, 0x58, 0x5C, 0x60, 0x64, 0x68, 0x6C, 0x70, 0x74, 0x78, 0x7D, 0x82, 0x87, 0x8C, 0x91, 0x96, 0x9B, 0xA0, 0xA5, 0xAA, 0xAF, 0xB4};
...
void Arduino_SSD1357::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = 0b01110001; break;
        case 2: r = 0b01100000; break;
        case 3: r = 0b01100011; break;
        default:  // case 0:
            r = 0b01110010;
            break;
    }
...
void Arduino_SSD1357::invertDisplay(bool i) { _bus->sendCommand(i ? SSD1357_INVERTDISPLAY : SSD1357_NORMALDISPLAY); }

void Arduino_SSD1357::displayOn(void) { _bus->sendCommand(SSD1357_DISPLAYON); }

void Arduino_SSD1357::displayOff(void) { _bus->sendCommand(SSD1357_DISPLAYOFF); }
