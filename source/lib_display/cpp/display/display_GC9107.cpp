...
Arduino_GC9107::Arduino_GC9107(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_GC9107::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = GC9107_MADCTL_MY | GC9107_MADCTL_MV | GC9107_MADCTL_BGR; break;
        case 2: r = GC9107_MADCTL_BGR; break;
        case 3: r = GC9107_MADCTL_MX | GC9107_MADCTL_MV | GC9107_MADCTL_BGR; break;
        default:  // case 0:
...
void Arduino_GC9107::invertDisplay(bool i) { _bus->sendCommand(_ips ? (i ? GC9107_INVOFF : GC9107_INVON) : (i ? GC9107_INVON : GC9107_INVOFF)); }
