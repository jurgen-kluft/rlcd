...
void Arduino_ILI9481_18bit::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = (ILI9481_MADCTL_MV | ILI9481_MADCTL_BGR | ILI9481_MADCTL_HF | ILI9481_MADCTL_VF); break;
        case 2: r = (ILI9481_MADCTL_BGR | ILI9481_MADCTL_HF); break;
        case 3: r = (ILI9481_MADCTL_MV | ILI9481_MADCTL_BGR); break;
        default:  // case 0:
...
void Arduino_ILI9481_18bit::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9481_INVON : ILI9481_INVOFF); }
