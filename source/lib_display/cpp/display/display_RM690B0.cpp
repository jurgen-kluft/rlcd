...
Arduino_RM690B0::Arduino_RM690B0(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_OLED(bus, rst, r, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_RM690B0::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_RM690B0::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = RM690B0_MADCTL_MX | RM690B0_MADCTL_MV | RM690B0_MADCTL_RGB; break;
        case 2: r = RM690B0_MADCTL_MX | RM690B0_MADCTL_MY | RM690B0_MADCTL_RGB; break;
        case 3: r = RM690B0_MADCTL_MV | RM690B0_MADCTL_MY | RM690B0_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_RM690B0::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? RM690B0_INVON : RM690B0_INVOFF); }
