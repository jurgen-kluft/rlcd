...
Arduino_OTM8009A::Arduino_OTM8009A(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_OTM8009A::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_OTM8009A::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = (OTM8009A_MADCTL_MY | OTM8009A_MADCTL_MV); break;
        case 2: r = (OTM8009A_MADCTL_MY | OTM8009A_MADCTL_MX); break;
        case 1: r = (OTM8009A_MADCTL_MX | OTM8009A_MADCTL_MV); break;
        default:  // case 0:
            r = 0;
            break;
    }
