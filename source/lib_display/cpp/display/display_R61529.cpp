...
bool Arduino_R61529::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_R61529::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = R61529_MADCTL_MV | R61529_MADCTL_MX | R61529_MADCTL_RGB; break;
        case 2: r = R61529_MADCTL_RGB | R61529_MADCTL_GS | R61529_MADCTL_MX; break;
        case 3: r = R61529_MADCTL_MV | R61529_MADCTL_RGB | R61529_MADCTL_GS; break;
        default:  // case 0:
            r = R61529_MADCTL_RGB;
            break;
    }
...
void Arduino_R61529::invertDisplay(bool i) { _bus->sendCommand(i ? R61529_INVON : R61529_INVOFF); }
