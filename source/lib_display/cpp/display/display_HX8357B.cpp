...
bool Arduino_HX8357B::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_HX8357B::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = (HX8357B_MADCTL_MX | HX8357B_MADCTL_MY | HX8357B_MADCTL_MV | HX8357B_MADCTL_BGR); break;
        case 2: r = (HX8357B_MADCTL_MY | HX8357B_MADCTL_BGR); break;
        case 1: r = (HX8357B_MADCTL_MV | HX8357B_MADCTL_BGR); break;
        default:  // case 0:
...
void Arduino_HX8357B::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? HX8357B_ENTER_INVERSION_MODE : HX8357B_EXIT_INVERSION_MODE); }
