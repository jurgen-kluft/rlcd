...
bool Arduino_ILI9486_18bit::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_ILI9486_18bit::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = (ILI9486_MADCTL_MV | ILI9486_MADCTL_BGR); break;
        case 2: r = (ILI9486_MADCTL_MY | ILI9486_MADCTL_BGR); break;
        case 3: r = (ILI9486_MADCTL_MY | ILI9486_MADCTL_MX | ILI9486_MADCTL_MV | ILI9486_MADCTL_BGR); break;
        case 4: r = (ILI9486_MADCTL_BGR); break;
        case 5: r = (ILI9486_MADCTL_MY | ILI9486_MADCTL_MV | ILI9486_MADCTL_BGR); break;
        case 6: r = (ILI9486_MADCTL_MY | ILI9486_MADCTL_MX | ILI9486_MADCTL_BGR); break;
        case 7: r = (ILI9486_MADCTL_MX | ILI9486_MADCTL_MV | ILI9486_MADCTL_BGR); break;
        default:  // case 0:
...
void Arduino_ILI9486_18bit::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9486_INVON : ILI9486_INVOFF); }
