...
Arduino_NT35510::Arduino_NT35510(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_NT35510::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_NT35510::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = (NT35510_MADCTL_MY | NT35510_MADCTL_MV); break;
        case 2: r = (NT35510_MADCTL_MY | NT35510_MADCTL_MX); break;
        case 1: r = (NT35510_MADCTL_MX | NT35510_MADCTL_MV); break;
        default:  // case 0:
            r = 0;
            break;
    }
...
void Arduino_NT35510::tftInit()
{
    ...
    // Gamma Setting
    uint8_t ini20[] = {0x00, 0x2D, 0x00, 0x2E, 0x00, 0x32, 0x00, 0x44, 0x00, 0x53, 0x00, 0x88, 0x00, 0xB6, 0x00, 0xF3, 0x01, 0x22, 0x01, 0x64, 0x01, 0x92, 0x01, 0xD4, 0x02, 0x07,
                       0x02, 0x08, 0x02, 0x34, 0x02, 0x5F, 0x02, 0x78, 0x02, 0x94, 0x02, 0xA6, 0x02, 0xBB, 0x02, 0xCA, 0x02, 0xDB, 0x02, 0xE8, 0x02, 0xF9, 0x03, 0x1F, 0x03, 0x7F};
