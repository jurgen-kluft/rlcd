...
Arduino_GC9D01::Arduino_GC9D01(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_GC9D01::invertDisplay(bool i) { _bus->sendCommand(_ips ? (i ? GC9D01_INVOFF : GC9D01_INVON) : (i ? GC9D01_INVON : GC9D01_INVOFF)); }
