...
Arduino_ST77916::Arduino_ST77916(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2, const uint8_t *init_operations, size_t init_operations_len)
...
bool Arduino_ST77916::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_ST77916::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = ST77916_MADCTL_MX | ST77916_MADCTL_MV | ST77916_MADCTL_RGB; break;
        case 2: r = ST77916_MADCTL_MX | ST77916_MADCTL_MY | ST77916_MADCTL_RGB; break;
        case 3: r = ST77916_MADCTL_MY | ST77916_MADCTL_MV | ST77916_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_ST77916::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ST77916_INVON : ST77916_INVOFF); }
