...
bool Arduino_ILI9486::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_ILI9486::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9486_INVON : ILI9486_INVOFF); }
