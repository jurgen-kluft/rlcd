...
bool Arduino_ILI9488::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_ILI9488::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9488_INVON : ILI9488_INVOFF); }
