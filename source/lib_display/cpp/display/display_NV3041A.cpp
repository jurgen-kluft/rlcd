...
Arduino_NV3041A::Arduino_NV3041A(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_NV3041A::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = NV3041A_MADCTL_MY | NV3041A_MADCTL_MV | NV3041A_MADCTL_RGB; break;
        case 2: r = NV3041A_MADCTL_RGB; break;
        case 3: r = NV3041A_MADCTL_MX | NV3041A_MADCTL_MV | NV3041A_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_NV3041A::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? NV3041A_INVON : NV3041A_INVOFF); }
