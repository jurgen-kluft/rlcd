...
Arduino_HX8347C::Arduino_HX8347C(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{ _invert = ips; }

bool Arduino_HX8347C::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
