...
Arduino_ST7789::Arduino_ST7789(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2, const uint8_t *init_operations, size_t init_operations_len)
...
void Arduino_ST7789::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = ST7789_MADCTL_MX | ST7789_MADCTL_MV | ST7789_MADCTL_RGB; break;
        case 2: r = ST7789_MADCTL_MX | ST7789_MADCTL_MY | ST7789_MADCTL_RGB; break;
        case 3: r = ST7789_MADCTL_MY | ST7789_MADCTL_MV | ST7789_MADCTL_RGB; break;
        case 4: r = ST7789_MADCTL_MX | ST7789_MADCTL_RGB; break;
        case 5: r = ST7789_MADCTL_MX | ST7789_MADCTL_MY | ST7789_MADCTL_MV | ST7789_MADCTL_RGB; break;
        case 6: r = ST7789_MADCTL_MY | ST7789_MADCTL_RGB; break;
        case 7: r = ST7789_MADCTL_MV | ST7789_MADCTL_RGB; break;
        default:  // case 0:
            r = ST7789_MADCTL_RGB;
            break;
    }
...
void Arduino_ST7789::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ST7789_INVON : ST7789_INVOFF); }
