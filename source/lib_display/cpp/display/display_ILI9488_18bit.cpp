...
bool Arduino_ILI9488_18bit::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_ILI9488_18bit::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ILI9488_INVON : ILI9488_INVOFF); }
