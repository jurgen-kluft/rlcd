...
Arduino_NT35310::Arduino_NT35310(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_NT35310::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_NT35310::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = NT35310_MADCTL_MY | NT35310_MADCTL_MV | NT35310_MADCTL_RGB; break;
        case 2: r = NT35310_MADCTL_MY | NT35310_MADCTL_MX | NT35310_MADCTL_RGB; break;
        case 1: r = NT35310_MADCTL_MX | NT35310_MADCTL_MV | NT35310_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_NT35310::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? NT35310_ENTER_INVERT_MODE : NT35310_EXIT_INVERT_MODE); }
