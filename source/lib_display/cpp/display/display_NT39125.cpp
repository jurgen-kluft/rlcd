...
Arduino_NT39125::Arduino_NT39125(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_NT39125::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_NT39125::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 3: r = NT39125_MADCTL_BGR | NT39125_MADCTL_MV | NT39125_MADCTL_MX | NT39125_MADCTL_MY; break;
        case 2: r = NT39125_MADCTL_BGR | NT39125_MADCTL_MY; break;
        case 1: r = NT39125_MADCTL_BGR | NT39125_MADCTL_MV; break;
        default:  // case 0:
...
void Arduino_NT39125::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? NT39125_INVON : NT39125_INVOFF); }
