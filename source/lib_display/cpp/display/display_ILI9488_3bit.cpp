...
Arduino_ILI9488_3bit::Arduino_ILI9488_3bit(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips)
    : Arduino_G(ILI9488_TFTWIDTH, ILI9488_TFTHEIGHT)
    , _bus(bus)
    , _rst(rst)
    , _rotation(r)
    , _ips(ips)
...
bool Arduino_ILI9488_3bit::begin(int32_t speed)
{
    ...
    switch (_rotation)
    {
        case 1: r = (ILI9488_MADCTL_BGR | ILI9488_MADCTL_MV); break;
        case 2: r = (ILI9488_MADCTL_BGR | ILI9488_MADCTL_MY); break;
        case 3: r = (ILI9488_MADCTL_BGR | ILI9488_MADCTL_MV | ILI9488_MADCTL_MX | ILI9488_MADCTL_MY); break;
        default:  // case 0:
...
void Arduino_ILI9488_3bit::drawBitmap(int16_t, int16_t, uint8_t *, int16_t, int16_t, uint16_t, uint16_t) { printf("Not Implemented drawBitmap()"); }

void Arduino_ILI9488_3bit::drawIndexedBitmap(int16_t, int16_t, uint8_t *, uint16_t *, int16_t, int16_t, int16_t) { printf("Not Implemented drawIndexedBitmap()"); }
...
void Arduino_ILI9488_3bit::draw16bitRGBBitmap(int16_t, int16_t, uint16_t *, int16_t, int16_t) { printf("Not Implemented draw16bitRGBBitmap()"); }

void Arduino_ILI9488_3bit::draw24bitRGBBitmap(int16_t, int16_t, uint8_t *, int16_t, int16_t) { printf("Not Implemented draw24bitRGBBitmap()"); }

void Arduino_ILI9488_3bit::invertDisplay(bool i) { _bus->sendCommand(i ? ILI9488_INVON : ILI9488_INVOFF); }
