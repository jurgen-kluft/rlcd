...
Arduino_JD9613::Arduino_JD9613(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_JD9613::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = JD9613_MADCTL_MX | JD9613_MADCTL_MV | JD9613_MADCTL_RGB; break;
        case 2: r = JD9613_MADCTL_MY | JD9613_MADCTL_MX | JD9613_MADCTL_RGB; break;
        case 3: r = JD9613_MADCTL_MY | JD9613_MADCTL_MV | JD9613_MADCTL_RGB; break;
        default:  // case 0:
            r = JD9613_MADCTL_RGB;
            break;
    }
...
void Arduino_JD9613::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? JD9613_INVON : JD9613_INVOFF); }
