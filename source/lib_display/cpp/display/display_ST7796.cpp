...
Arduino_ST7796::Arduino_ST7796(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_ST7796::begin(int32_t speed) { return begin(speed, GFX_NOT_DEFINED); }
...
void Arduino_ST7796::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = ST7796_MADCTL_MX | ST7796_MADCTL_MV | ST7796_MADCTL_BGR; break;
        case 2: r = ST7796_MADCTL_MX | ST7796_MADCTL_MY | ST7796_MADCTL_BGR; break;
        case 3: r = ST7796_MADCTL_MY | ST7796_MADCTL_MV | ST7796_MADCTL_BGR; break;
        case 4: r = ST7796_MADCTL_MX | ST7796_MADCTL_BGR; break;
        case 5: r = ST7796_MADCTL_MX | ST7796_MADCTL_MY | ST7796_MADCTL_MV | ST7796_MADCTL_BGR; break;
        case 6: r = ST7796_MADCTL_MY | ST7796_MADCTL_BGR; break;
        case 7: r = ST7796_MADCTL_MV | ST7796_MADCTL_BGR; break;
        default:  // case 0:
            r = ST7796_MADCTL_BGR;
            break;
    }
...
void Arduino_ST7796::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? ST7796_INVON : ST7796_INVOFF); }
