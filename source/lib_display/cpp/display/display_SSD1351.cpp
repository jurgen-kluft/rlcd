...
Arduino_SSD1351::Arduino_SSD1351(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_SSD1351::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = 0b01110111; break;
        case 2: r = 0b01100110; break;
        case 3: r = 0b01100101; break;
        default:  // case 0:
            r = 0b01110100;
            break;
    }
...
void Arduino_SSD1351::invertDisplay(bool i) { _bus->sendCommand(i ? SSD1351_INVERTDISPLAY : SSD1351_NORMALDISPLAY); }

void Arduino_SSD1351::displayOn(void) { _bus->sendCommand(SSD1351_DISPLAYON); }

void Arduino_SSD1351::displayOff(void) { _bus->sendCommand(SSD1351_DISPLAYOFF); }
