...
Arduino_NV3023::Arduino_NV3023(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
...
void Arduino_NV3023::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = NV3023_MADCTL_MY | NV3023_MADCTL_MV | NV3023_MADCTL_MX | NV3023_MADCTL_BGR; break;
        case 2: r = NV3023_MADCTL_MX | NV3023_MADCTL_BGR; break;
        case 3: r = NV3023_MADCTL_MV | NV3023_MADCTL_BGR; break;
        default:  // case 0:
...
void Arduino_NV3023::invertDisplay(bool i) { _bus->sendCommand(_ips ? (i ? NV3023_INVOFF : NV3023_INVON) : (i ? NV3023_INVON : NV3023_INVOFF)); }
