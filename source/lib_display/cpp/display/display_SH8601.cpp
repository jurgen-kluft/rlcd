...
Arduino_SH8601::Arduino_SH8601(Arduino_DataBus *bus, int8_t rst, uint8_t r, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_OLED(bus, rst, r, w, h, col_offset1, row_offset1, col_offset2, row_offset2)
{
}

bool Arduino_SH8601::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_SH8601::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = SH8601_MADCTL_COLOR_ORDER; break;
        case 2: r = SH8601_MADCTL_COLOR_ORDER | SH8601_MADCTL_Y_AXIS_FLIP | SH8601_MADCTL_X_AXIS_FLIP; break;
        case 3: r = SH8601_MADCTL_COLOR_ORDER; break;
        case 4: r = SH8601_MADCTL_COLOR_ORDER | SH8601_MADCTL_X_AXIS_FLIP; break;
        case 5: r = SH8601_MADCTL_COLOR_ORDER; break;
        case 6: r = SH8601_MADCTL_COLOR_ORDER | SH8601_MADCTL_Y_AXIS_FLIP; break;
        case 7: r = SH8601_MADCTL_COLOR_ORDER; break;
        default:  // case 0:
...
void Arduino_SH8601::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? SH8601_C_INVON : SH8601_C_INVOFF); }
