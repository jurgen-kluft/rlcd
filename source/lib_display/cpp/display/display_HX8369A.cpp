...
Arduino_HX8369A::Arduino_HX8369A(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2)
    : Arduino_TFT(bus, rst, r, ips, w, h, col_offset1, row_offset1, col_offset2, row_offset2)

{
}

bool Arduino_HX8369A::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_HX8369A::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 7: r = (HX8369A_MADCTL_MV); break;
        case 6: r = (HX8369A_MADCTL_MY); break;
        case 5: r = (HX8369A_MADCTL_MY | HX8369A_MADCTL_MX | HX8369A_MADCTL_MV); break;
        case 4: r = (HX8369A_MADCTL_MX); break;
        case 3: r = (HX8369A_MADCTL_MY | HX8369A_MADCTL_MV); break;
        case 2: r = (HX8369A_MADCTL_MY | HX8369A_MADCTL_MX); break;
        case 1: r = (HX8369A_MADCTL_MX | HX8369A_MADCTL_MV); break;
        default:  // case 0:
            r = 0;
            break;
    }
...
void Arduino_HX8369A::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? HX8369A_ENTER_INVERSION_MODE : HX8369A_EXIT_INVERSION_MODE); }
