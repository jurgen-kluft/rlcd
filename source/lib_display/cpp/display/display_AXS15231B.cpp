...
Arduino_AXS15231B::Arduino_AXS15231B(Arduino_DataBus *bus, int8_t rst, uint8_t r, bool ips, int16_t w, int16_t h, uint8_t col_offset1, uint8_t row_offset1, uint8_t col_offset2, uint8_t row_offset2, const uint8_t *init_operations,
...
void Arduino_AXS15231B::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = AXS15231B_MADCTL_MX | AXS15231B_MADCTL_MV | AXS15231B_MADCTL_RGB; break;
        case 2: r = AXS15231B_MADCTL_MX | AXS15231B_MADCTL_MY | AXS15231B_MADCTL_RGB; break;
        case 3: r = AXS15231B_MADCTL_MY | AXS15231B_MADCTL_MV | AXS15231B_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_AXS15231B::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? AXS15231B_INVON : AXS15231B_INVOFF); }
