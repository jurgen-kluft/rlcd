...
bool Arduino_RM67162::begin(int32_t speed) { return Arduino_TFT::begin(speed); }
...
void Arduino_RM67162::setRotation(uint8_t r)
{
    ...
    switch (_rotation)
    {
        case 1: r = RM67162_MADCTL_MX | RM67162_MADCTL_MV | RM67162_MADCTL_RGB; break;
        case 2: r = RM67162_MADCTL_MX | RM67162_MADCTL_MY | RM67162_MADCTL_RGB; break;
        case 3: r = RM67162_MADCTL_MV | RM67162_MADCTL_MY | RM67162_MADCTL_RGB; break;
        default:  // case 0:
...
void Arduino_RM67162::invertDisplay(bool i) { _bus->sendCommand((_ips ^ i) ? RM67162_INVON : RM67162_INVOFF); }
