...
void Arduino_Canvas_3bit::writePixelPreclipped(int16_t x, int16_t y, uint16_t color)
{
    ...
    int32_t idx = pos >> 1;
    uint8_t c   = (((color & 0b1000000000000000) ? 0b100 : 0) | ((color & 0b0000010000000000) ? 0b010 : 0) | ((color & 0b0000000000010000) ? 0b001 : 0));
    if (pos & 1)
    {
...
uint8_t *Arduino_Canvas_3bit::getFramebuffer() { return _framebuffer; }
